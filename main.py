...
class Starter():
    def __init__(self):
        ...
        try:
            ...
            parser.add_argument("--find-emails-not-in-logs", "-f" , type = str, help = "Find emails that are not in the provided logs file. Print the numbers of found emails, then one found email per line sorted alphabetically.")
